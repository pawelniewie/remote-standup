IntercomRails.config do |config|
  # == Intercom app_id
  #
  config.app_id = ENV["INTERCOM_APP_ID"] || "j9aomwvk"

  # == Intercom secret key
  # This is required to enable secure mode, you can find it on your Intercom
  # "security" configuration page.
  #
  config.api_secret = "_vbS3RCDbY9ogY8j_S1Bf7vYB2yPWQm2zwal00pr"
  ...
  #
  config.api_key = "b0f138449bf3de2c6912990cd0a0bac06aad4aa5"
  ...
  config.user.custom_data = {
    :number_of_notes => Proc.new { |current_user| current_user.notes.count },
    :team_size => Proc.new { |current_user| current_user.team.users.count }
  }
